...
var MainContent = function () {
    return (<>
      <motion.div initial="hidden" animate="visible" className="flex flex-col lg:flex-row items-center justify-center px-10 lg:px-20 xl:px-32 2xl:px-40 mt-20 w-full z-[20] relative">
        <div className='flex flex-col items-center gap-3 lg:items-start text-justify h-full w-full justify-center'>
          <motion.div variants={slideInFromLeft(0.5)} className='text-neutral-800 font-bold flex flex-col text-center lg:text-start gap-6 mt-6 text-6xl xl:text-7xl 2xl:text-8xl h-auto w-auto lg:px-16 xl:px-20 2xl:px-24'>
            <span>
              Welcome!
              <br />We are 
          ...
          <motion.p variants={slideInFromLeft(0.6)} className='text-xs lg:text-lg xl:text-base 2xl:text-xl text-neutral-800 my-5 max-w-[700px] lg:px-16 xl:px-20 2xl:px-24 text-center text-justify' style={{ textShadow: '2px 2px 4px rgba(255, 255, 255, 0.4)' }}>
        ...
        <div className='w-full flex flex-col items-center justify-center py-4'>
          <motion.img variants={slideInFromBottomtime(0.6)} src="/thuyen0.png" alt="" className='w-full h-auto' animate={{
            x: [0, -15, 0],
        }} transition={{
            duration: 5,
            repeat: Infinity,
